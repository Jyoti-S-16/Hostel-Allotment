        ...
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          <div className="card" style={{ width: "12rem" }}>
            <div className="card-body">
              ...
              <h6 className="card-subtitle mb-2 text-muted">Branch</h6>
              <p
                onClick={() => this.onBatchSelect("2016")}
                className="card-text"
                style={{
                  cursor: "pointer",
                  color: "#00a4eb",
          ...
          <div className="card" style={{ width: "12rem" }}>
            <div className="card-body">
              ...
              <h6 className="card-subtitle mb-2 text-muted">Branch</h6>
              <p
                onClick={() => this.onBatchSelect("2017")}
                className="card-text"
                style={{
                  cursor: "pointer",
                  color: "#00a4eb",
          ...
          <div className="card" style={{ width: "12rem" }}>
            <div className="card-body">
              ...
              <h6 className="card-subtitle mb-2 text-muted">Branch</h6>
              <p
                onClick={() => this.onBatchSelect("2018")}
                className="card-text"
                style={{
                  cursor: "pointer",
                  color: "#00a4eb",
          ...
          <div className="card" style={{ width: "12rem" }}>
            <div className="card-body">
              ...
              <h6 className="card-subtitle mb-2 text-muted">Branch</h6>
              <p
                onClick={() => this.onBatchSelect("2019")}
                className="card-text"
                style={{
                  cursor: "pointer",
                  color: "#00a4eb",
        ...
        <div style={{ marginTop: "50px", overflow: "scroll", maxHeight: 800 }}>
          {!loading ? (
            ...
            <div style={{ display: "flex", justifyContent: "center" }}>
              <ReactLoading type="bars" color="#f56f42" />
            </div>
          )}
        </div>
      </div>
